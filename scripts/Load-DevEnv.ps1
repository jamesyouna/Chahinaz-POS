...
$allowed = @('POS_DB_NAME','POS_DB_HOST','POS_DB_PORT','POS_DB_USER','POS_DB_PASSWORD','POS_BOOTSTRAP_ADMIN_USERNAME','POS_BOOTSTRAP_ADMIN_PASSWORD','POS_SECURE_COOKIE','POS_IMAGE_DIR')
